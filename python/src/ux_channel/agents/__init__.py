...
class _AgentsPackage(ModuleType):
    ...
    def __call__(self, channel: Any, **kwargs: Any) -> Any:
        from ux_channel.agents_api import agents as _facade
...
try:
    ...
    from ux_channel.agents_api import agents as _facade_fn
...
from ux_channel.agents_api import Agents, EffectReport, agents, attach_agents  # noqa: E402
from ux_channel.agent_peer import AgentPeer, dispatch_peer, peer_intent  # noqa: E402
